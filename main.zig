...
fn isSpace(pos: u8) callconv(.Inline) bool {
...
test "toMerge" {
    ...
    arr = [_]u32{ 0, 2, 0, 4 };
    toMerge(&arr);
    expect(eql(u32, &arr, &[_]u32{ 0, 2, 0, 4 }));

    arr = [_]u32{ 2, 2, 4, 4 };
    toMerge(&arr);
    expect(eql(u32, &arr, &[_]u32{ 4, 0, 8, 0 }));

    arr = [_]u32{ 8, 0, 2, 2 };
    toMerge(&arr);
    expect(eql(u32, &arr, &[_]u32{ 8, 0, 4, 0 }));

    arr = [_]u32{ 2, 2, 2, 2 };
    toMerge(&arr);
    expect(eql(u32, &arr, &[_]u32{ 4, 0, 4, 0 }));

    arr = [_]u32{ 4, 2, 0, 2 };
    toMerge(&arr);
    expect(eql(u32, &arr, &[_]u32{ 4, 4, 0, 0 }));

    arr = [_]u32{ 2, 4, 2, 0 };
    toMerge(&arr);
    expect(eql(u32, &arr, &[_]u32{ 2, 4, 2, 0 }));

    arr = [_]u32{ 2, 2, 16, 2 };
    toMerge(&arr);
    expect(eql(u32, &arr, &[_]u32{ 4, 0, 16, 2 }));
}
...
test "toLeft" {
    ...
    toMerge(&arr);
    toLeft(&arr);
    expect(eql(u32, &arr, &[_]u32{ 2, 4, 0, 0 }));

    arr = [_]u32{ 2, 2, 4, 4 };
    toMerge(&arr);
    toLeft(&arr);
    expect(eql(u32, &arr, &[_]u32{ 4, 8, 0, 0 }));

    arr = [_]u32{ 8, 0, 2, 2 };
    toMerge(&arr);
    toLeft(&arr);
    expect(eql(u32, &arr, &[_]u32{ 8, 4, 0, 0 }));
    ...
    toMerge(&arr);
    toLeft(&arr);
    expect(eql(u32, &arr, &[_]u32{ 4, 16, 2, 0 }));
}
